...
def custom_score(game, player):
    ...
    myplayerMoves=game.get_legal_moves(player)
    oplayerMoves=game.get_legal_moves(game.get_opponent(player))
    return len(myplayerMoves)-1.5*len(oplayerMoves)
...
class MinimaxPlayer(IsolationPlayer):
    ...
    def minimax(self, game, depth):
        ...
        **********************************************************************
        ...
        def terminal_test(self,game,depth,flag):
            if self.time_left() < self.TIMER_THRESHOLD:
                raise SearchTimeout()
